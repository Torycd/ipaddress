...
const Ip = () => {
  ...
  return (
    ...
    >
    <h2 className="mt-10 text-center font-bold text-3xl">IP Address Tracker</h2>
      <form onSubmit={handleForm} className="flex justify-center mt-10">
        <input
          className="rounded-tl-full rounded-bl-full w-[300px] p-5"
          name="ip-input"
          minLength="7"
          maxLength="15"
          size="15"
        ...
        />
        <button className="bg-black w-[80px] rounded-tr-full rounded-br-full">g</button>
      </form>
    </div>
  );
};
