...
const Details = () => {
  return (
    <div className="mx-20 md:mx-20 z-50 text-center md:text-left bg-white space-y-5 md:space-y-0 text-black rounded-lg translate-y-1/2 grid md:grid-cols-4 p-10 justify-center md:space-x-5">
